...
import { getSareeCustomers, getCompletedSareeCustomers } from '../services/api';
...
export default function SareeListScreen({ navigation }) {
    ...
    const loadCustomers = async () => {
        ...
        try {
            const response =
                activeTab === 'pending'
                    ? await getSareeCustomers()
                    : await getCompletedSareeCustomers();
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Saree Design</Text>
                <TouchableOpacity
                    style={styles.addButton}
                    onPress={() => navigation.navigate('SareeForm')}
                >
