...
export default function ChuridarFormScreen({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Add Churidar Customer</Text>
                <View style={{ width: 60 }} />
            </View>
                    ...
                    <View style={styles.row}>
                        <View style={[styles.inputGroup, styles.halfWidth]}>
                            ...
                            <TextInput
                                ...
                                onChangeText={(value) => updateField('topLength', value)}
                                placeholder="0"
                                keyboardType="numeric"
                            />
                        </View>
                        ...
                        <View style={[styles.inputGroup, styles.halfWidth]}>
                            <Text style={styles.label}>Bottom Length</Text>
                            <TextInput
                                style={styles.input}
                                value={formData.bottomLength}
                                onChangeText={(value) => updateField('bottomLength', value)}
                                placeholder="0"
                                keyboardType="numeric"
                            />
                        </View>
