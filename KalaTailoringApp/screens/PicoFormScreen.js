...
import { addPicoCustomer } from '../services/api';

export default function PicoFormScreen({ navigation }) {
    ...
    const handleSubmit = async () => {
        if (!formData.costomerName || !formData.costomerNumber) {
        ...
        setLoading(true);
        try {
            const response = await addPicoCustomer(formData);
            if (response.success) {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Add Pico Fall Customer</Text>
                <View style={{ width: 60 }} />
            </View>
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                <View style={styles.form}>
                    ...
                    <View style={styles.inputGroup}>
                        ...
                        <TextInput
                            style={styles.input}
                            value={formData.costomerName}
                            onChangeText={(value) => updateField('costomerName', value)}
                    ...
                    <View style={styles.inputGroup}>
                        ...
                        <TextInput
                            style={styles.input}
                            value={formData.costomerNumber}
                            onChangeText={(value) => updateField('costomerNumber', value)}
                    ...
                    <View style={styles.inputGroup}>
                        ...
                        <TextInput
                            style={styles.input}
                            value={formData.costomerPrice}
                            onChangeText={(value) => updateField('costomerPrice', value)}
                    ...
                    <View style={styles.row}>
                        <View style={[styles.inputGroup, styles.halfWidth]}>
                            <Text style={styles.label}>Saree Length</Text>
                            <TextInput
                                style={styles.input}
                                value={formData.sareeLength}
                                onChangeText={(value) => updateField('sareeLength', value)}
                                placeholder="0"
                                keyboardType="numeric"
                            />
                        </View>
                        ...
                        <View style={[styles.inputGroup, styles.halfWidth]}>
                            <Text style={styles.label}>Fall Length</Text>
                            <TextInput
                                style={styles.input}
                                value={formData.fallLength}
                                onChangeText={(value) => updateField('fallLength', value)}
                                placeholder="0"
                                keyboardType="numeric"
                            />
                        </View>
                    ...
                    <View style={styles.inputGroup}>
                        <Text style={styles.label}>Pico Type</Text>
                        <View style={styles.typeSelector}>
                            {['Normal', 'Designer', 'Premium'].map((type) => (
                                <TouchableOpacity
                                    key={type}
                                    style={[
                                        styles.typeButton,
                                        formData.picoType === type && styles.activeTypeButton,
                                    ]}
                                    onPress={() => updateField('picoType', type)}
                                >
                                    <Text
                                        style={[
                                            styles.typeButtonText,
                                            formData.picoType === type && styles.activeTypeButtonText,
                                        ]}
                                    >
                                        {type}
                                    </Text>
